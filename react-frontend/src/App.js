...
import SignUpChargignstation from './Components/SignUpChargingstation';
    ...
    <div >
      ...
      <div className='container'>
        <Routes>
          ...
          <Route path='/add-customer'element={<SignUpCustomer/>} />
          <Route path='/add-chargingstation' element={<SignUpChargignstation/>} />
          <Route path='/aboutus' element={<AboutPageComponent/>} />
          <Route path='/stationlist' element={<ChargingstationList/>} />
        </Routes>
      </div>
