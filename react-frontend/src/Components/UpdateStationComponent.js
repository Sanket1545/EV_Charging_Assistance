...
const UpdateStationComponent = () => {
    ...
    useEffect(() => {
        ...
        ChargingstationService.getChargingstationById(id).then((response) => {
    ...
    function updateChargingstation(e) {
        ...
        ChargingstationService.updateChargingstation(id, chargingstation).then((response) => {
            console.log(response.data);
            alert("Profile Updated Successfully.");
            navigate(`/chargingstationpage/${id}`);
        }).catch(error => {
            console.log(error);
        })
    }
    ...
    const cancelChargingstation=(e)=>{
        e.preventDefault();
        navigate(`/chargingstationpage/${id}`);
        alert("Chargingstation not updated.");
    }
